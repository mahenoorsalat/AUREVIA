...
import { Globe, Users, Briefcase, TrendingUp, Linkedin, Twitter, Instagram, Facebook, Mail, Phone, ArrowRight, Star, Code, MessageSquare, CheckCircle } from 'lucide-react';
...
export default function App() {
 ...
 <div  style={{
    ...
    backgroundRepeat: "no-repeat",
        ...
        <header   className="w-full px-6 md:px-12 lg:px-20 py-4 md:py-6">
          <div className="flex items-center justify-between max-w-[1600px] mx-auto">
            <div className="flex items-center">
              <img className="h-8 md:h-14 lg:h-14 hover:scale-105 transition-transform cursor-pointer" src="./LOGO.png" alt="Aurevia Logo" />
            </div>
            ...
            <button className="bg-[#0D0029] text-white font-semibold px-6 py-2 rounded-full hover:bg-[#FF316F] transition-all duration-300 hover:scale-105 text-sm lg:text-base">
              Contact Us
            </button>
          </div>
        </header>
        ...
        {/* Hero Section */}
       <section
  className="w-full px-6 md:px-12 lg:px-20 py-12 md:py-20 lg:py-28"
 
>
          <div className="max-w-[1600px] mx-auto">
            <div className="relative">
              <div className="absolute -top-10 -right-10 md:-top-20 md:-right-20 lg:-top-32 lg:-right-32 opacity-20 pointer-events-none">
                <Globe className="w-32 h-32 md:w-48 md:h-48 lg:w-64 lg:h-64 text-[#FF316F]" />
              </div>
              
              <h1 className="text-3xl md:text-5xl lg:text-7xl font-extrabold text-[#0D0029] leading-tight mb-6 md:mb-8">
                Building Careers Through<br/>Global Collaboration and<br/>Remote Excellence
              </h1>
              
              <p className="text-base md:text-lg lg:text-xl text-[#0D0029] font-medium max-w-4xl leading-relaxed mb-8">
              ...
              <div className="flex flex-wrap items-center gap-4 md:gap-6">
                ...
                <a href="#learn-more" className="flex items-center gap-2 cursor-pointer hover:gap-4 transition-all group text-[#0D0029] font-semibold">
